...
for (i in 1..15) {
    when { 
        i % 3 == 0 && i % 5 == 0 -> map.put(i, "FIZZBUZZ")
        i % 3 == 0 -> map.put(i, "FIZZ")
        i % 5 == 0 -> map.put(i, "BUZZ")
        else -> map.put(i, "")
    }
}
for ((key, value) in map) {
    mapFoldResults += "$value"
}
...
/*EXTRA CREDIT 
1. Seneca (/ˈsɛnɪkə/), was a Roman Stoic philosopher, statesman, dramatist, and—in one work—satirist 
of the Silver Age of Latin literature.
2. The school of philosophy he is most associate with is Stoicism. 
3. Stoicism asserts that virtue is happiness and judgment should be based on 
